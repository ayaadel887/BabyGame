...
import 'Animals.dart';
import 'AnimalsL1.dart';
import 'AnimalsL2.dart';



class AnimalsLevels extends StatefulWidget {

  @override
  _AnimalsLevelsState createState() => _AnimalsLevelsState();
}

class _AnimalsLevelsState extends State<AnimalsLevels>  with SingleTickerProviderStateMixin {
            ...
            child: Container(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  _part(top: MediaQuery.of(context).size.height/3,right: 360,color: Colors.lightGreen,value: 1 ,page: ()=>AnimalsL1()),
